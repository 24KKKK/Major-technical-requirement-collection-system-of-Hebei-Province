...
<body>
	...
	<%
		...
		System.out.println("formal_lycheck页面的Inamenum" + Inamenum);
		System.out.println("formal_lycheck页面的ly" + ly);
		if (submit != null) {
			String s = "update xssh set xsreason=" + "'" + ly + "'" + " where Inamenum=" + "'" + Inamenum + "'";
			...
			if (i == 1) {
				...
				out.println("<script language='javaScript'> alert('在线填写形式审核意见失败，请重新填写！');</script>");
				response.setHeader("refresh", "0;url=formal_ly.jsp");
			}
		}
		db.close();
	%>
