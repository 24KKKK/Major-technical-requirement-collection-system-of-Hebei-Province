...
String Inamenum=(String)request.getParameter("Inamenum");
	System.out.println("formal_lyjs页面的Inamenum:"+Inamenum);
%>
	<h1 align="center" class="one">技术审核意见</h1>
	<br />
	<form name="homeForm" method="post" action="formal_lycheckjs.jsp">
		<table>
			<tr>
				<td colspan="5"><span class="xing">*</span>请简单填写一下对该重大技术征集表的技术审核意见（限100字以内）</td>
			</tr>
			<tr>
