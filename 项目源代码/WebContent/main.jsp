...
//									String Iname = request.getParameter("Iname");
									...
									System.out.println("主界面的Iname：" + Iname);
								%>
								<li><span id="username"> </span>您好：<%=Iname%>！今天是 <script>
							...
							<div class="bs_navright">
								<span class="icon_no hand"
									onclick='top.Dialog.confirm("确定要退出系统吗",function(){window.location="exitServlet"});'>退出系统</span>
								<div class="clear"></div>
							</div>
							<div class="clear"></div>
						</div>
						...
						<div id="lbox_middlecenter">
							<div id="lbox_middleleft">
								<div id="lbox_middleright">
									<div id="bs_left">
										<IFrame scrolling="yes" width="100%" height="500"
											frameBorder=2 id=frmleft name=frmleft
											src="leftPages/accordition.html" allowTransparency="true">
										</IFrame>
									</div>
						...
						<div id="rbox_middlecenter">
							<div id="rbox_middleleft">
								<div id="rbox_middleright">
									<div id="bs_right">
										<IFRAME scrolling="yes" width="100%" height="500"
											frameBorder=1 id=frmright name=frmright src="Welcome.html"
											allowTransparency="true"> </IFRAME>
									</div>
									<!--更改左侧栏的宽度需要修改id="bs_right"的样式-->
								</div>
