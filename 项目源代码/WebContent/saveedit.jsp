...
<script type="text/javascript">
	...
	function check_jichu() {
		...
		if (jichu[0].checked == true) {
			...
			// 			document.getElementById('学科分类').style.disabled = true;
			// 			document.getElementById('所属领域').style.disabled = true;
			// 			document.getElementById('应用行业').style.disabled = true;
			// 			 					  document.getElementById('学科分类').style.disabled = true;
			// 			 					  document.getElementById('领域').style.disabled = true;
			// 			 					  document.getElementById('lingyu1').style.disabled = true;
			// 			 					  document.getElementById('lingyu2').style.disabled = true;
			// 								  document.getElementById('行业').style.disabled = true;
			// 			 					  document.getElementById('应用行业').style.display="none";

		} else if (jichu[1].checked == true || jichu[2].checked == true
				|| jichu[3].checked == true || jichu[4].checked == true) {
			document.getElementById("table2").style.display = "block"
			// 			document.getElementById('学科分类').style.display = "block";
			// 			document.getElementById('所属领域').style.display = "block";
			// 			document.getElementById('应用行业').style.display = "block";
			// 					  document.getElementById('学科分类').style.display="inline";
			// 					  document.getElementById('领域').style.display="inline";
			// 					  document.getElementById('lingyu1').style.display="inline";
			// 					  document.getElementById('lingyu2').style.display="inline";
			// 					  document.getElementById('行业').style.display="block";
			// 					  document.getElementById('应用行业').style.display="inline";

		}
	}

	// 	function chuancan() //获取保存或者提交按钮传递的值
	// 	{
	// 		var btnname = document.getElementById("save").value;
	// 		var url = "AddXuqiu.jsp?value=" + btnname;
	// 		document.write("第一个页面的" + btnname + url);
				...
				<td align="center"><table width="900" border="1" align="center">
						...
						<table border="1" name="table2" id="table2">
							<tr id="学科分类">
								...
								<%
									ResultSet rs2 = db.executeQuery("select * from first order by firstID");
								%>
								<td colspan="5" cols="100" align="center" width="270">
									<p id="学科分类">
