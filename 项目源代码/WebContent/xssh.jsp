...
<body>
	...
	<%
		...
		System.out.println("xssh界面的Iname：" + Iname);
		System.out.println("xssh界面的Inamenum：" + Inamenum);

		rs.close();
	%>
	<form id="form2" method="post" action="xsshresult.jsp">
		...
		<center>
			<input type="submit" name="submit" id="submit" value="通过"
				onclick="this.form.action='xsshsuccresult.jsp';this.form.submit();" />
			<input type="submit" name="submit" id="submit" value="不通过"
				onclick="this.form.action='xsshfailresult.jsp';this.form.submit();" />
		</center>
	</form>
	<%
		rs.close();
